...
exports.mockAnthropicAPI = exports.mockHuggingFaceAPI = exports.mockEmbeddingService = exports.mockFirebaseAdmin = exports.TestUtils = exports.mockAssetBundle = exports.mockRAGEmbeddings = exports.mockPortalUrls = exports.mockPortalConfig = exports.mockCreativeCV = exports.mockExecutiveCV = exports.mockStandardCV = exports.mockMinimalCV = void 0;
const portal_1 = require("../types/portal");
// ============================================================================
// CV TEST FIXTURES
// ============================================================================
exports.mockMinimalCV = {
    personalInfo: {
        name: 'Jane Smith',
...
exports.mockPortalConfig = {
    ...
    status: portal_1.PortalStatus.PENDING,
    urls: {
        portal: '',
        chat: '',
        contact: '',
...
class TestUtils {
    ...
    static generateRandomCV(options = {}) {
        ...
        const baseCV = Object.assign({}, exports.mockStandardCV);
        if (complexity === 'minimal') {
            return {
                personalInfo: baseCV.personalInfo,
                summary: baseCV.summary,
                skills: (_a = baseCV.skills) === null || _a === void 0 ? void 0 : _a.slice(0, 3)
            };
        }
        if (complexity === 'complex') {
            return Object.assign(Object.assign({}, baseCV), { experience: Array(experienceYears).fill(null).map((_, i) => (Object.assign(Object.assign({}, baseCV.experience[0]), { company: `Company ${i + 1}`, startDate: `${2020 - i}-01-01`, endDate: `${2021 - i}-01-01` }))), skills: Array(20).fill(null).map((_, i) => ({
                    name: `Skill ${i + 1}`,
                    level: 'Advanced',
                    category: 'Technology'
     ...
     */
    static generateMockEmbeddings(count) {
