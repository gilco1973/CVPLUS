  ...
  async (request) => {
    ...
    try {
      ...
      if (jobData?.quickCreate || jobData?.settings?.applyAllEnhancements) {
        ...
        const generatedCV = {
          html: `<html><body><h1>${parsedCV.personalInfo.name}</h1><p>Professional CV generated by GetMyCV.ai</p></body></html>`,
          pdfUrl: `https://storage.googleapis.com/getmycv-ai.appspot.com/generated/${jobId}/cv.pdf`,
          docxUrl: `https://storage.googleapis.com/getmycv-ai.appspot.com/generated/${jobId}/cv.docx`
        };
