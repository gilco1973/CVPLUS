...
import type { AdvancedATSScore, ATSOptimizationResult } from '../types/enhanced-models';
...
describe('ATS Phase 1 Integration Tests', () => {
      ...
      experience: [
        {
          ...
          responsibilities: ['Team leadership', 'System architecture', 'Code review'],
  ...
  describe('Advanced Multi-Factor Scoring', () => {
    test('should generate comprehensive ATS analysis', async () => {
      const result = await atsService.analyzeAdvancedATS(mockParsedCV);
    ...
    test('should provide ATS system-specific scores', async () => {
      ...
      expect(result.advancedScore.atsSystemScores).toBeDefined();
    ...
    test('should generate prioritized recommendations', async () => {
      ...
      expect(result.advancedScore.recommendations).toBeDefined();
    ...
    test('should include competitor benchmark analysis', async () => {
      ...
      expect(result.advancedScore.competitorBenchmark).toBeDefined();
  ...
  describe('Semantic Keyword Analysis', () => {
    test('should provide enhanced keyword analysis', async () => {
      const result = await atsService.analyzeAdvancedATS(mockParsedCV, 'Software Engineer');
    ...
    test('should identify industry-specific terms', async () => {
      const result = await atsService.analyzeAdvancedATS(mockParsedCV, 'Software Engineer', ['technology']);
      
      expect(result.semanticAnalysis.industrySpecificTerms).toBeDefined();
      expect(Array.isArray(result.semanticAnalysis.industrySpecificTerms)).toBe(true);
      
      // Should include some technology-related terms
      const hasRelevantTerms = result.semanticAnalysis.industrySpecificTerms.some(term =>
  ...
  describe('ATS System Simulation', () => {
    test('should simulate different ATS platforms', async () => {
      ...
      const workdaySimulation = result.systemSimulations.find(sim => sim.system === 'workday');
    ...
    test('should provide system-specific optimization tips', async () => {
      ...
      const anySimulationWithTips = result.systemSimulations?.some(sim => 
  ...
  describe('Error Handling and Edge Cases', () => {
    ...
    test('should handle network failures gracefully', async () => {
      ...
      const serviceWithTimeout = new AdvancedATSOptimizationService({
        enableVerification: false // Disable to avoid network calls
      });
  ...
  describe('Performance Tests', () => {
    test('should complete analysis within acceptable time', async () => {
      ...
      await atsService.analyzeAdvancedATS(mockParsedCV);
