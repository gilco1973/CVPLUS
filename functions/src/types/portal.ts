/**
 * Portal Generation Types for CVPlus Web Portal Feature
 * 
 * This file defines comprehensive TypeScript interfaces for the portal generation system
 * that creates personalized professional websites with RAG-based AI chat functionality.
 * 
 * @author Gil Klainert
 * @created 2025-08-19
 * @version 1.0
