...
const TestScenario_1 = require("../../../src/models/TestScenario");
describe('TestScenarioModel', () => {
    ...
    describe('Construction and Initialization', () => {
        it('should create a valid TestScenario with all properties', () => {
            const scenario = new TestScenario_1.TestScenarioModel(validTestScenarioData);
    ...
    describe('Validation', () => {
        it('should throw error for empty name', () => {
            expect(() => {
                new TestScenario_1.TestScenarioModel({
    ...
    describe('Status Management', () => {
        let scenario;
        beforeEach(() => {
            scenario = new TestScenario_1.TestScenarioModel(validTestScenarioData);
        });
    ...
    describe('Step Management', () => {
        let scenario;
        beforeEach(() => {
            scenario = new TestScenario_1.TestScenarioModel({
                ...validTestScenarioData,
                steps: [
                    {
                        order: 1,
    ...
    describe('Serialization', () => {
        ...
        it('should deserialize from JSON correctly', () => {
            const json = scenario.toJSON();
            const deserialized = TestScenario_1.TestScenarioModel.fromJSON(json);
        ...
        it('should handle round-trip serialization/deserialization', () => {
            ...
            const deserialized = TestScenario_1.TestScenarioModel.fromJSON(parsed);
    ...
    describe('Edge Cases', () => {
        ...
        it('should handle different scenario types', () => {
            const types = ['e2e', 'integration', 'api', 'load', 'regression'];
            types.forEach(type => {
                expect(() => {
                    new TestScenario_1.TestScenarioModel({
                        ...validTestScenarioData,
    ...
    describe('Performance', () => {
        it('should handle large step arrays efficiently', () => {
            ...
            const scenario = new TestScenario_1.TestScenarioModel({
                ...validTestScenarioData,
                steps: largeSteps
            });
...
//# sourceMappingURL=TestScenario.test.js.map