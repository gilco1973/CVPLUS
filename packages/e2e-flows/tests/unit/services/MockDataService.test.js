...
describe('MockDataService', () => {
    let service;
    beforeEach(() => {
        service = new MockDataService_1.MockDataService();
    });
    afterEach(() => {
        service.clearCache();
    });
    describe('Constructor and Initialization', () => {
        it('should initialize with default cache options', () => {
            const defaultService = new MockDataService_1.MockDataService();
        ...
        it('should initialize with custom cache options', () => {
            ...
            const customService = new MockDataService_1.MockDataService(customOptions);
    ...
    describe('Data Set Management', () => {
        describe('createDataSet', () => {
            it('should create a new data set with required fields', async () => {
                ...
                const dataSet = await service.createDataSet('Test CV', 'cv', testData);
            ...
            it('should create a data set with custom options', async () => {
                ...
                const dataSet = await service.createDataSet('Custom Test', 'user-profile', testData, {
                    id: customId,
        ...
        describe('listDataSets', () => {
            ...
            it('should sort results by updatedAt descending', async () => {
                ...
                for (let i = 1; i < dataSets.length; i++) {
                    expect(dataSets[i - 1].updatedAt.getTime()).toBeGreaterThanOrEqual(dataSets[i].updatedAt.getTime());
                }
            });
        });
    ...
    describe('Data Generation', () => {
        describe('generateData', () => {
            ...
            it('should throw error for unknown type', async () => {
                ...
                await expect(service.generateData(options)).rejects.toThrow('No template found for type unknown-type');
            });
        ...
        describe('generateFromTemplate', () => {
            ...
            it('should throw error for non-existent template', async () => {
                await expect(service.generateFromTemplate('non-existent-template')).rejects.toThrow('Template non-existent-template not found');
            });
        });
    });
    ...
    describe('Data Export/Import', () => {
        let testDataSet;
        beforeEach(async () => {
            testDataSet = await service.createDataSet('Export Test', 'cv', {
                name: 'John Doe',
        ...
        describe('exportDataSet', () => {
            ...
            it('should export as CSV for array data', async () => {
                const arrayDataSet = await service.createDataSet('Array Test', 'cv', [
            ...
            it('should handle CSV export with quotes in data', async () => {
                const quotedDataSet = await service.createDataSet('Quoted Test', 'cv', { description: 'A "quoted" description', title: 'Software Engineer' });
            ...
            it('should throw error for non-existent data set', async () => {
                await expect(service.exportDataSet('non-existent', { format: 'json' })).rejects.toThrow('Data set non-existent not found');
            });
            it('should throw error for unsupported format', async () => {
                await expect(service.exportDataSet(testDataSet.id, { format: 'pdf' })).rejects.toThrow('Unsupported export format: pdf');
            });
        });
...
skills:
  ...
  - Django`;
            ...
            it('should throw error for unsupported import format', async () => {
                await expect(service.importDataSet('data', 'xml', {})).rejects.toThrow('Unsupported import format: xml');
            });
            it('should handle invalid JSON', async () => {
                await expect(service.importDataSet('invalid json', 'json', {})).rejects.toThrow();
            });
    ...
    describe('Cache Management', () => {
        ...
        describe('cleanupExpired', () => {
            it('should remove expired data sets', async () => {
                ...
                expiredDataSet.expiresAt = new Date(Date.now() - 1000);
            ...
            it('should return count of cleaned up data sets', async () => {
                ...
                expired1.expiresAt = new Date(Date.now() - 1000);
                const expired2 = await service.createDataSet('Expired 2', 'cv', { data: '2' });
                expired2.expiresAt = new Date(Date.now() - 1000);
                const cleanedCount = await service.cleanupExpired();
    ...
    describe('Private Method Behavior (through public interface)', () => {
        ...
        describe('Cache Eviction', () => {
            it('should evict oldest cache entries when size limit is reached', async () => {
                ...
                const smallCacheService = new MockDataService_1.MockDataService({
    ...
    describe('Edge Cases and Error Handling', () => {
        ...
        it('should handle concurrent operations', async () => {
            ...
            const promises = Array.from({ length: 10 }, (_, i) => service.createDataSet(`Concurrent ${i}`, 'cv', { index: i }));
        ...
        it('should handle cache expiration correctly', async () => {
            ...
            const shortCacheService = new MockDataService_1.MockDataService({
                maxAge: 50 // 50ms
            });
    ...
    describe('Performance Tests', () => {
        it('should handle bulk operations efficiently', async () => {
            ...
            const createPromises = Array.from({ length: 100 }, (_, i) => service.createDataSet(`Bulk ${i}`, 'cv', { index: i }));
        ...
        it('should maintain performance with large schemas', async () => {
            ...
            const largeData = Object.fromEntries(Array.from({ length: 100 }, (_, i) => [`field${i}`, `value${i}`]));
            const startTime = Date.now();
...
//# sourceMappingURL=MockDataService.test.js.map