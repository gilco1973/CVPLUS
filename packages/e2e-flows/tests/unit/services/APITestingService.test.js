...
describe('APITestingService', () => {
    ...
    beforeEach(() => {
        service = new APITestingService_1.APITestingService();
    ...
    const createTestCaseData = (overrides = {}) => ({
        id: 'default-test-id',
        name: 'Default Test',
    ...
    const createAssertion = (overrides = {}) => ({
        type: 'status',
        operator: 'equals',
        expectedValue: 200,
    ...
    describe('Constructor and Initialization', () => {
        it('should initialize with empty collections', () => {
            const newService = new APITestingService_1.APITestingService();
    ...
    describe('Test Case Management', () => {
        describe('createTestCase', () => {
            it('should create a new test case', async () => {
                ...
                expect(testCase).toBeInstanceOf(models_1.APITestCaseModel);
    ...
    describe('Test Suite Management', () => {
        describe('createTestSuite', () => {
            ...
            it('should create test suite with options', () => {
                const testCase = new models_1.APITestCaseModel(createTestCaseData({
                    id: 'suite-test',
                    name: 'Suite Test',
                    endpoint: '/api/test',
                    method: 'GET'
    ...
    describe('Test Execution', () => {
        ...
        describe('executeTestCase', () => {
            ...
            it('should handle POST requests with body', async () => {
                ...
                expect(mockRequest.write).toHaveBeenCalledWith(JSON.stringify({ name: 'John Doe', email: 'john@example.com' }));
            });
        ...
        describe('executeTestSuite', () => {
            ...
            it('should throw error for non-existent suite', async () => {
                ...
                await expect(service.executeTestSuite('non-existent-suite', options)).rejects.toThrow('Test suite non-existent-suite not found');
            });
        });
        describe('executeMultipleTestCases', () => {
            ...
            it('should throw error for missing test cases', async () => {
                ...
                await expect(service.executeMultipleTestCases(['missing-1', 'missing-2'], options)).rejects.toThrow('Test cases not found: missing-1, missing-2');
            });
        });
    ...
    describe('Result Management', () => {
        ...
        describe('generateReport', () => {
            ...
            it('should throw error for unsupported format', () => {
                expect(() => {
                    service.generateReport(sampleResults, 'pdf');
    ...
    describe('Edge Cases and Error Handling', () => {
        ...
        it('should handle assertion evaluation errors', async () => {
            ...
            await expect(service.createTestCase(createTestCaseData({
                ...
                assertions: [
                    createAssertion({
                        type: 'unsupported', // Invalid assertion type
                        operator: 'equals',
                        expectedValue: 'test',
...
//# sourceMappingURL=APITestingService.test.js.map