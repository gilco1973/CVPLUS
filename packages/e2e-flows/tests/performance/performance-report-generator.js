...
class PerformanceReportGenerator {
    results = [];
    outputDir;
    constructor(outputDir = '/tmp/performance-reports') {
     ...
     */
    addServiceResults(serviceName, serviceResults) {
        ...
        new Chart(memoryCtx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: ${JSON.stringify(Object.values(serviceGroups).map(results => results.reduce((sum, r) => sum + r.memoryUsed, 0) / results.length / 1024 / 1024))},
...
exports.default = PerformanceReportGenerator;
//# sourceMappingURL=performance-report-generator.js.map