...
describe('E2EFlowsService Performance Tests', () => {
    ...
    beforeAll(async () => {
        service = new E2EFlowsService_1.E2EFlowsService();
    });
    afterAll(() => {
    ...
    const createTestScenario = async (name, stepCount, complexity = 'simple') => {
        const steps = [];
...
//# sourceMappingURL=E2EFlowsService.performance.test.js.map